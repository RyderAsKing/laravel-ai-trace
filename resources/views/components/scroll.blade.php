<div
    ...
    {{ $attributes->merge(['class' => '@container/scroll-wrapper relative flex w-full flex-grow overflow-hidden basis-56', ':class' => "loading && 'animate-pulse opacity-25'"]) }}
>
    ...
    <div x-ref="fade" class="pointer-events-none absolute bottom-0 left-0 right-0 h-6 origin-bottom bg-white/90 dark:bg-gray-900/90" wire:ignore></div>
</div>
